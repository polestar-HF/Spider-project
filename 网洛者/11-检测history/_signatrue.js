...
function History(){}
History = new History
Object.defineProperty(History, "arguments", {
    configurable: false,
    enumerable: false,
    value: null,
    writable: false
})
Object.defineProperty(History, "caller", {
    configurable: false,
    enumerable: false,
    value: null,
    writable: false
...
// ['length', 'scrollRestoration', 'state', 'back', 'forward', 'go', 'pushState', 'replaceState', 'constructor', Symbol(Symbol.toStringTag)]

History.prototype = {
    get length(){
        return TypeError('Illegal invocation')
    },
