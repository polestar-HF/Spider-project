...
function vmProxy(object, name) {
    return new Proxy(object, {
        get(target, property, receiver) {
            ...
            // 打印日志
            console.log(`get ${name} --> ${property} --> value: ${result}`);
            // 返回结果
            return result
        },
        set(target, property, value, receiver) {
            // 打印日志
            console.log(`set ${name} --> ${property} --> value: ${value}`);
...
CanvasRenderingContext2D.toString = function(){return '[object CanvasRenderingContext2D]'}
CanvasRenderingContext2D.name = 'CanvasRenderingContext2D'
safefunction(CanvasRenderingContext2D)
// canvas
function HTMLCanvasElement() {}
canvas = new HTMLCanvasElement();
canvas.getContext = function getContext(val){
    if(val === '2d'){
        return CanvasRenderingContext2D
    }
}
canvas = vmProxy(canvas, 'canvas')
safefunction(canvas)
// document
...
document.getElementById = function getElementById(){console.log(arguments)}
safefunction(document.getElementById)
document.getElementsByClassName = function getElementsByClassName(){console.log(arguments)}
safefunction(document.getElementsByClassName)
...
location.toString = function() {return 'https://www.zhihu.com/search?type=content&q=%E7%99%BE%E5%BA%A6'}
location.href = 'https://www.zhihu.com/search?type=content&q=%E7%99%BE%E5%BA%A6'
...
history = vmProxy(history, 'history');
...
safefunction(screen)
alert = function(val){console.log(val)}
                    ...
                    switch (this.T) {
                        ...
                        case 455:
                            this.C[3] = this.C[this.W][Q](),
                                // console.log(this.C, "hahha", Q, this.C[this.W][Q]())
                                this.T -= 103 + G.length;
                            break;
                        case 453:
                            B = this.e >> 17 & 3,
...
function sign(md5Str) {
    ...
    return '2.0_' + data.default(md5Str)
}
