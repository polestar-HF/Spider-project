...
Navigator.prototype[Symbol.toStringTag] = Navigator.name
navigator = vmProxy(new Navigator());
v_saf(navigator)

function Location() {}
Location.prototype[Symbol.toStringTag] = Location.name
location = vmProxy(new Location());
v_saf(location)

function History() {}
History.prototype[Symbol.toStringTag] = History.name

history = vmProxy(new History());
v_saf(history)

function Screen() {}
Screen.prototype[Symbol.toStringTag] = Screen.name

screen = vmProxy(new Screen());
v_saf(screen)
