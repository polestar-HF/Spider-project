...
function rsaFingerprint(a, b) {
    var c = '{"user_agent":"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Saf","language":"zh-CN","color_depth":"24","pixel_ratio":"1","hardware_concurrency":"8","resolution":"1920,1080","available_resolution":"1920,1040","timezone_offset":"-480","session_storage":"1","local_storage":"1","indexed_db":"1","open_database":"1","cpu_class":"unknown","navigator_platform":"Win32","do_not_track":"unknown","regular_plugins":"APlayer ActiveX hosting plugin::APlayer III ActiveX hosting plugin for Firefox::application/x-thunde","webgl_vendor":"Google Inc.~ANGLE (AMD Radeon(TM) Vega 8 Mobile Graphics Direct3D11 vs_5_0 ps_5_0)","adblock":"false","has_lied_languages":"false","has_lied_resolution":"false","has_lied_os":"false","has_lied_browser":"false","touch_support":"0,false,false","js_fonts":"Arial,Arial Black,Arial Narrow,Calibri,Cambria,Cambria Math,Comic Sans MS,Consolas,Courier,Courier N"}'
        , d = "e26eedee746735c08e3e42cd334ab9d6"
        , e = c.length
        , f = ""
        , g = new RSAKey;
    g.setPublic(a, b);
...
var ddd = getPassWrod("1111111");
console.log(ddd);
console.log(rsaFingerprint(modulus, publicExponent))