/*
cookie参数 RM4hZBv0dDon443M 的加密算法

// RM4hZBv0dDon443M --> AES加密算法的key不是定值，但是好像可以固定长度，把cookie中的m参数的值添加到数组的最后面
_0x4e96b4['_$pr'] = ["c82df5cfa1f191b72a561944524e2aed", "16df7193a0740123cb040c201528fae4", "9db24ae3062d74336addcee0df794398"]
...
// 因为node里面没有windows对象，所以采用jsdom模拟JavaScript的window对象属性  _0x4e96b4（window对象）
// 使用jsdom模拟JavaScript window对象 --> failure --> 加密出来的 m 值与浏览器加密的不一样，估计是被检测了 --> 不成立
...
const _0x4e96b4 = window;
// 公共数据 小技巧：JavaScript复制长数组 --> copy(array_name)
var _$UH = [
    "name",
    "setAttribute",
    "type",
...
// _0x4e96b4['_$pr'] = new _0x4d2d2c(); // 存放 AES 加密的key数组
// _0x4e96b4['_$tT'] = -0xa40bd9c;
// _0x4e96b4['_$Jy'] = 0x1b821d58;
// --------------------(踩坑(没补下面3个属性结果与浏览不一样) --> 参考knox)
...
function _0x474032(_0x233f82, _0xe2ed33, _0x3229f9) {
    // 返回的结果  _0x37614a(_0x233f82)
    return _0x37614a(_0x233f82);
}

// RM4hZBv0dDon443M --> AES加密算法的key不是定值，但是好像可以固定长度，把cookie中的m参数的值添加到数组的最后面
// function cookie_m() {
//     var m = +new Date() // 时间戳 这个时间戳与url中m的时间戳参数一样
//     var f = Date.parse(new Date()) // 这是url中的f参数（时间戳），cookie过期时间 --> 当前时间戳 - f > 50s --> cookie过期
//     // console.log("m: ", m)
//     // console.log("f: ", f)
//     return _0x474032(1634220015735)
// }

// console.log(cookie_m())
// var key = cookie_m()   m 参数
// --------------------------------RM4h生成-----------------------------------

// _0x4e96b4['_$qF'] = _$Tk['enc']['Utf8'][_$UH[0xff]](_0x4e96b4['btoa']("1634220015735")['slice'](0x0, 0x10)) //AES 加密的 key --> 传入时间戳 --> m
...
// _0x4e96b4['_$pr'] = [
//     "7f2244b00ad79b353af5bd0f31ae3453",
//     "95209bfa6d95ecc2bd0a229d9b3a1342",
//     "b53f591acf3dc255a1929df5ced60b9f",
//     "d2e7a5bd1a95f8ff3d172cc8fbef1aeb"] // 存放需要AES加密数组
function NewTime() {
    return +new Date()
}
...
function cookie() {
    ...
    _0x4e96b4['_$Jy'] = 0x1b821d58;
    // 生成要AES加密的字符串
    _0x4e96b4['_$pr']['push'](_0x474032(NewTime()))
    _0x4e96b4['_$pr']['push'](_0x474032(NewTime()))
    _0x4e96b4['_$pr']['push'](_0x474032(NewTime()))
    _0x4e96b4['_$pr']['push'](_0x474032(NewTime()))
    // 中间
    ...
    var m = +new Date() // 时间戳 这个时间戳与url中m的时间戳参数一样
    var f = Date.parse(new Date()) // 这是url中的f参数（时间戳），cookie过期时间 --> 当前时间戳 - f > 50s --> cookie过期
    _0x4e96b4['_$pr']['push'](_0x474032(m)) // 存放 AES 加密的key
    _0x4e96b4['_$qF'] = _$Tk['enc']['Utf8'][_$UH[0xff]](_0x4e96b4['btoa'](m)['slice'](0x0, 0x10)) //AES 加密的 key --> 传入时间戳 --> m
    var _$Ww = _$Tk["enc"]["Utf8"]["parse"](_0x4e96b4['_$pr']["toString"]()),
        _0x29dd83 = _$Tk["AES"]["encrypt"](_$Ww, _0x4e96b4["_$qF"], {
            'mode': _$Tk["mode"]["ECB"],
            'padding': _$Tk["pad"]["Pkcs7"]
        })
    return [m, f, _0x474032(m), _0x29dd83[_$UH[0x1f]]()]
}
