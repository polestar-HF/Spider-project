...
sessionStorage = {
    getItem: function (val) {
        ...
        if (val === '_byted_param_sw'){
            return '6sArSJoTc9YF9o/SzGo='
        }
        if (val === 'tt_scid'){
            return 'nugBpykrJmvX29MAd4Ul.Y4iVc7s-7UT79npVyIJpe.WeYl.JrpAtSLzOuOv2pxD4d3f'
        }
    },
    removeItem :undefined_function
}
localStorage = {
    getItem: function (val) {
        if (val === '__ac_referer'){
...
location = {
    href: 'https://www.toutiao.com/?wid=1656861971529',
    protocol: 'https:'
}
navigator = {
...
// _signature的长度与cookie有关
document.cookie = 'msToken=98OuKGsubqCh5Jy-F9Jx7Cpj8AQGE6c-D7ZkFqNNalV2H03fq1ItWeL45szQv9WDHbtTgN1NBYl1qzkq93UANp4Rv64toRnqi9HgPImQbLoI; __ac_signature=_02B4Z6wo00f01xKCKqgAAIDCmcmxSn7v1IcSoi4AAKZr43; ttcid=683adefa7cc44c1a876bb6c0dcc4d93f14; local_city_cache=%E6%B7%B1%E5%9C%B3; _tea_utm_cache_24=undefined; csrftoken=8f4b8b6870b3ed4b1384be103b6a03ed; s_v_web_id=verify_l55guby8_t9jQwKMQ_iZqn_4oKp_8EKe_Hx69v710qWZd; tt_scid=nugBpykrJmvX29MAd4Ul.Y4iVc7s-7UT79npVyIJpe.WeYl.JrpAtSLzOuOv2pxD4d3f; MONITOR_WEB_ID=95d43043-66fd-402e-9280-d9925219adee'
function get_signature(url_) {
    return window.byted_acrawler.sign({url: url_})
}
// "undefined" != typeof exports ? exports : void 0  node 环境运行结果 Object(), node 环境运行结果 undefined, 所以直接设置为 "undefined" != typeof exports ? undefined : undefined
console.log(get_signature('https://www.toutiao.com/api/pc/list/feed?channel_id=0&max_behot_time=1656863002&category=pc_profile_recommend&aid=24&app_name=toutiao_web'))