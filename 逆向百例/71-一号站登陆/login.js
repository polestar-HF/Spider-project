...
function encrypt(username, password, code, vvccookie) {
    var jsondata_rsa = {};
    jsondata_rsa['username'] = username; // 用户名
    jsondata_rsa['loginpass'] = password; // 密码
    jsondata_rsa['code'] = CryptoJS.MD5(code).toString(); // md5加密的验证码
    jsondata_rsa['vvccookie'] = vvccookie // 主页input标签的value值
    jsondata_rsa = rsa_encrypt(JSON.stringify(jsondata_rsa));
    return jsondata_rsa
}

let username = "11111111111";
let password = "123456";
let code = "155772";
let vvccookie = "7563d8e618626166520fd08cdba43834";
console.log(encrypt(username, password, code, vvccookie))
