...
!function(e) {
    function r(r) {
        for (var n, u, i = r[0], c = r[1], f = r[2], d = 0, p = []; d < i.length; d++)
            u = i[d],
            ...
            if (t)
                ...
                i.src = function(e) {
                    return u.p + "static/chunks/" + ({
                        ...
                        28: "c6aa71dd8f7be9fa88e7",
                        56: "df35e3cf22e0d1fb55a0",
                        57: "6c6a36b4928c4f230935",
                        58: "9fe81184a7d9339b21b4"
                    }[e] + ".js"
                }(e);
                var c = new Error;
                a = function(r) {
...
// let param = {os: 'web', sv: '7.7.5', app: 'CailianpressWeb'}
let param = {
    "rn": 20,
    "lastTime": 1661090893,
    "category": "",
...
let key = Object.keys(param).sort().map((x) => {
    return x + "=" + param[x]
}).join("&")
var t = i.sync(key)
console.log(t)
